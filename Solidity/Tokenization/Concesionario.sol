...
contract Concesionario is Ownable {
    ...
    */
    ...
    /**
    * @dev Constructor al que se le pasa la direccion del contrato Banco y RegistroTrafico
    */
    constructor(Banco banco_, RegistroTrafico registroTrafico_) {
        banco = banco_;
    ...
    * que el comprador haya dado permiso approve a este contrato para mover el dinero en Banco
    */
    function comprarAnuncio(bytes32 matricula_) public {
        ...
        banco.transferFrom(msg.sender, propietario, anuncio.precioVenta);
